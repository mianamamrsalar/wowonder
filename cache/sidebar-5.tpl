<div class="sidebar-conatnier">
    <div class="col-md-3 sidebar rightcol">
		...
		<!-- <div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="http://localhost/wowonder/upload/photos/d-cover.jpg?cache=0" alt="qasim iqbal Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-5" alt="qasim iqbal Profile Picture" src="http://localhost/wowonder/upload/photos/d-avatar.jpg?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=qasimiqbal" href="http://localhost/wowonder/qasimiqbal">qasim iqbal</a>
					<p>@qasimiqbal</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="http://localhost/wowonder/qasimiqbal" data-ajax="?link1=timeline&u=qasimiqbal">
						<span class="split-link"><b>posts</b></span>
						<span id="user_post_count">0</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="http://localhost/wowonder/qasimiqbal/following" data-ajax="?link1=timeline&u=qasimiqbal&type=following">
							<span class="split-link"><b>Following</b></span>
							<span>2</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="http://localhost/wowonder/qasimiqbal/followers" data-ajax="?link1=timeline&u=qasimiqbal&type=followers">
	...
	<div class="wow_content wow_my_groups">
		<div class="avatar">
			<a href="http://localhost/wowonder/lecture" data-ajax="?link1=timeline&u=lecture">
				<img src="http://localhost/wowonder/upload/photos/d-group.jpg " alt="Lecture Group Profile Picture" />
			</a>
		</div>
		<div class="wow_my_groups_info">
			<h3 class="page_title"><a href="http://localhost/wowonder/lecture" data-ajax="?link1=timeline&u=lecture">Lecture Group</a></h3>
			<p>2 Members</p>
			<span id="join-1">
       ...
       <span class="button-text"> Join</span>
        ...
        <div id="sidebar-sticky">
                ...
                <li class="activities-wrapper" id="activities-wrapper">
                    <div class="activity wow_side_acts " data-activity-id="11">
	<div class="notification-list">
		<div class="notification-user-avatar pull-left">
			<a href="http://localhost/wowonder/admin" data-ajax="?link1=timeline&u=admin" title="#"><img src="http://localhost/wowonder/upload/photos/d-avatar.jpg?cache=0" alt="http://localhost/wowonder/upload/photos/d-avatar.jpg?cache=0Profile picture"></a>
		...
		<div class="notification-text wo_sidebar_activity">
			...
			<span class="user-popover" data-id="1" data-type="user">
				<a class="main-color" href="http://localhost/wowonder/admin " data-ajax="?link1=timeline&u=admin">
					admin				</a>
			</span>
			started following <a class="second-user-color" data-ajax="?link1=timeline&u=qasimiqbal" href="http://localhost/wowonder/qasimiqbal">qasim iqbal</a>			<span class="notification-time active">
				<span class="ajax-time" title="2020-08-07T09:55:01+00:00">
					3 days ago				</span>
			</span>
			</div>
		</div>
...
</div><div class="activity wow_side_acts " data-activity-id="10">
	<div class="notification-list">
		<div class="notification-user-avatar pull-left">
			<a href="http://localhost/wowonder/waseemibrar" data-ajax="?link1=timeline&u=waseemibrar" title="#"><img src="http://localhost/wowonder/upload/photos/2020/08/knIvJos4LfMTKBJkcAef_10_c7bf7cddca2e88d30e54f9c03c504ce6_avatar.jpg?cache=1597036130" alt="http://localhost/wowonder/upload/photos/d-avatar.jpg?cache=0Profile picture"></a>
			<span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user-plus active"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg></span>
		</div>
		<div class="notification-text wo_sidebar_activity">
			<div>
			<span class="user-popover" data-id="4" data-type="user">
				<a class="main-color" href="http://localhost/wowonder/waseemibrar " data-ajax="?link1=timeline&u=waseemibrar">
					waseem ibrar				</a>
			</span>
			started following <a class="second-user-color" data-ajax="?link1=timeline&u=qasimiqbal" href="http://localhost/wowonder/qasimiqbal">qasim iqbal</a>			<span class="notification-time active">
				<span class="ajax-time" title="2020-08-07T06:12:59+00:00">
					3 days ago				</span>
			</span>
			</div>
		</div>
	...
	<div class="footer-wrapper-sidebar">
		...
		<ul class="list-inline">
			<li><a data-ajax="?link1=terms&type=about-us" href="http://localhost/wowonder/terms/about-us">About</a></li>
						<li><a data-ajax="?link1=contact-us" href="http://localhost/wowonder/contact-us">Contact Us</a></li>
				...
				<div class="dropdown dropup sun_foot_drop_menu">
					...
					<ul class="dropdown-menu dropdown-menu-right" role="menu">
						<li><a data-ajax="?link1=terms&type=privacy-policy" href="http://localhost/wowonder/terms/privacy-policy">Privacy Policy</a></li>
						<li><a data-ajax="?link1=terms&type=terms" href="http://localhost/wowonder/terms/terms">Terms of Use</a></li>
																	</ul>
				</div>
			</li> 
		</ul>
