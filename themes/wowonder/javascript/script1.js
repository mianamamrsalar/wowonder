...
function Wo_EditPost(post_id) {
  ...
  var edit_title = post.find('.edit-title-' + post_id + ' textarea');
  var title = edit_title.val();
  var edit_desc = post.find('.edit-desc-' + post_id + ' textarea');
  var desc = edit_desc.val();
  var edit_tags = post.find('.edit-tags-' + post_id + ' textarea');
