...
if ($f == 'posts') {
    ...
    if ($s == 'insert_new_post') {
        ...
        if (isset($_FILES['postMusic']['name']) && empty($mediaFilename)) {
            if ($_FILES['postMusic']['size'] > $wo['config']['maxUpload']) {
                ...
                if (!empty($media)) {
                    ...
                    if (!empty($_FILES['thumbnail']) && in_array($_FILES["thumbnail"]["type"], $img_types)) {
                        $fileInfo = array(
        ...
        if (!empty($_POST['postdescription']) && !ctype_space($_POST['postdescription'])) {
            $post_description = $_POST['postdescription'];
        }
        if (!empty($_POST['posttags']) && !ctype_space($_POST['posttags'])) {
        ...
        if (empty($errors) && $invalid_file == false) {
            ...
            $post_data = array(
                ...
                'postDescription' => Wo_Secure($post_description),
                'postTags' => Wo_Secure($post_tags),
